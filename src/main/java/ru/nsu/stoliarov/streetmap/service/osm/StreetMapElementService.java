...
import ru.nsu.stoliarov.streetmap.service.retention.IRetentionStrategy;
import ru.nsu.stoliarov.streetmap.service.retention.RetentionStrategiesHolder;
import ru.nsu.stoliarov.streetmap.service.speedtest.SpeedTestDataHolder;
...
public class StreetMapElementService {
    ...
    public Boolean persistToDbShortFile(RetentionOptions retentionOptions) {
        return persistToDb(retentionOptions, SHORT_XML_FILE_NAME, false);
    }

    public Boolean persistToDbHugeFile(RetentionOptions retentionOptions) {
    ...
    private Boolean persistToDb(RetentionOptions retentionOptions, String fileName, boolean isBzip) {
